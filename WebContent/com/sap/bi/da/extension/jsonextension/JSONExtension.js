...
*/
jQuery.sap.require("com.sap.bi.da.extension.jsonextension.ExtensionUtils");

define(["service!sap.bi.da.extension.sdk.clientRequestService", "JSONExtensionDialogController"], function (ClientRequestService, JSONExtensionDialogController) {
    "use strict";
    
    var ExtensionUtils = new com.sap.bi.da.extension.jsonextension.ExtensionUtils();
    
    function JSONExtension() {

        var EXTENSION_ID = "com.sap.bi.da.extension.jsonextension";
        ...
        var createJSONExtensionDialog = function(acquisitionState, workflow) {
            var oDeferred = new jQuery.Deferred();
            var controller = new JSONExtensionDialogController(acquisitionState, oDeferred, fServiceCall, workflow, ExtensionUtils);
        ...
        this.doCreateWorkflow = function(acquisitionState) {
            return createJSONExtensionDialog(acquisitionState, "CREATE");
        };

    	// This function will be called during an edit dataset workflow
        this.doEditWorkflow = function(acquisitionState) {
            return createJSONExtensionDialog(acquisitionState, "EDIT");
        };
    ...
    JSONExtension.prototype.getConnectionDescription = function(acquisitionState) {
    ...
    JSONExtension.prototype.getIcon48 = function() {
        return "/img/48.png";
    };
    JSONExtension.prototype.getIcon32 = function() {
        return "/img/32.png";
    };
    // The white version of the icon will be displayed when the extension is highlighted in the New Dataset dialog
    JSONExtension.prototype.getIcon32_white = function() {
        return "/img/32_w.png";
    };
    JSONExtension.prototype.getIcon24 = function() {
        return "/img/24.png";
    };
    JSONExtension.prototype.getIcon16 = function() {
        return "/img/16.png";
    };
